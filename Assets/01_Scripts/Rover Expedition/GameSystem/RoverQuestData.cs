...
namespace Jun
{
    ...
    public class RoverQuestData
    {
        ...
        public RoverQuestData(int questID, string name, string content, int questTarget, int reward, GameObject rewardObject, int progressGoal, int questType)
        {
