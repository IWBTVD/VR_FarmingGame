...
namespace AmbientSounds {
    ...
    public class SequenceDataEditor : PWEditor, IPWEditor {
        ...
        void OnEnable() {
            ...
            m_eventsReorderable.headerHeight = EditorGUIUtility.singleLineHeight;
            m_eventsReorderable.drawHeaderCallback = DrawEventHeader;

            m_valuesReorderable = new UnityEditorInternal.ReorderableList(serializedObject, m_values, true, true, true, true);
            m_valuesReorderable.drawElementCallback = DrawValuesElement;
            m_valuesReorderable.headerHeight = EditorGUIUtility.singleLineHeight;
            ...
            m_clipsReorderable = new UnityEditorInternal.ReorderableList(serializedObject, m_clipData, true, true, true, true);
            m_clipsReorderable.elementHeight = EditorGUIUtility.singleLineHeight;
            m_clipsReorderable.drawElementCallback = DrawClipElement;
            m_clipsReorderable.headerHeight = EditorGUIUtility.singleLineHeight;
            m_clipsReorderable.drawHeaderCallback = DrawClipHeader;
            m_clipsReorderable.onAddCallback = OnAddClip;

            m_modifiersReorderable = new UnityEditorInternal.ReorderableList(serializedObject, m_modifiers, true, true, true, true);
            ...
            m_modifiersReorderable.headerHeight = EditorGUIUtility.singleLineHeight;
            m_modifiersReorderable.drawHeaderCallback = DrawModifierHeader;

            m_eventsWhilePlayingReorderable = new UnityEditorInternal.ReorderableList(serializedObject, m_eventsWhilePlaying, true, true, true, true);
            ...
            m_eventsWhilePlayingReorderable.headerHeight = EditorGUIUtility.singleLineHeight;
            m_eventsWhilePlayingReorderable.drawHeaderCallback = DrawEventsWhilePlayingHeader;

            m_valuesWhilePlayingReorderable = new UnityEditorInternal.ReorderableList(serializedObject, m_valuesWhilePlaying, true, true, true, true);
            ...
            m_valuesWhilePlayingReorderable.headerHeight = EditorGUIUtility.singleLineHeight;
