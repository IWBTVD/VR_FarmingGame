    ...
    public class SliderRangeEditor : PropertyDrawer {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            if (Event.current.type == EventType.MouseDown && Event.current.button == 0)
            {
                ...
                {
                    curDraggingProp = property.propertyPath;
            ...
            else if (curDraggingProp == property.propertyPath)
            {
                if (Event.current.type == EventType.MouseDrag && curDraggingProp == property.propertyPath)
                {
                    hasChanged = true;
