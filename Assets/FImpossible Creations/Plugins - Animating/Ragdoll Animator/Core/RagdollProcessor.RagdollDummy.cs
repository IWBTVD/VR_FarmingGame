    ...
    public partial class RagdollProcessor
    {
        ...
        private void PrepareRagdollDummy(Transform objectWithAnimator, Transform rootBone)
        {
            ...
            if (BonesSetupMode == EBonesSetupMode.HumanoidLimbs)
            {
                ...
                if (LeftShoulder) lShould = FindChildByNameInDepth(prefix + LeftShoulder.name, RagdollDummySkeleton, true, null, true);
                if (RightShoulder) rShould = FindChildByNameInDepth(prefix + RightShoulder.name, RagdollDummySkeleton, true, null, true);
                if (Chest) chestBone = FindChildByNameInDepth(prefix + Chest.name, RagdollDummySkeleton, true, null, true);

                SetRagdollTargetBones(
                    RagdollDummySkeleton,
                        PelvisInDummy,
                        FindChildByNameInDepth(prefix + SpineStart.name, RagdollDummySkeleton, true, null, true),
                        chestBone,
                        FindChildByNameInDepth(prefix + Head.name, RagdollDummySkeleton, true, null, true),

                        FindChildByNameInDepth(prefix + LeftUpperArm.name, RagdollDummySkeleton, true, null, true),
                        FindChildByNameInDepth(prefix + LeftForeArm.name, RagdollDummySkeleton, true, null, true),
                        FindChildByNameInDepth(prefix + RightUpperArm.name, RagdollDummySkeleton, true, null, true),
                        FindChildByNameInDepth(prefix + RightForeArm.name, RagdollDummySkeleton, true, null, true),

                        FindChildByNameInDepth(prefix + LeftUpperLeg.name, RagdollDummySkeleton, true, null, true),
                        FindChildByNameInDepth(prefix + LeftLowerLeg.name, RagdollDummySkeleton, true, null, true),
                        FindChildByNameInDepth(prefix + RightUpperLeg.name, RagdollDummySkeleton, true, null, true),
                        FindChildByNameInDepth(prefix + RightLowerLeg.name, RagdollDummySkeleton, true, null, true),
                        lShould, rShould
                    );
        ...
        public void PreGenerateDummy(Transform objectWithAnimator, Transform rootBone)
        {
            ...
            if (RagdollDummyBase) RagdollDummyBase.SetParent(BaseTransform, true);
#endif
        }
