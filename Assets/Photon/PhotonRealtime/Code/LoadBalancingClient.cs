...
namespace Photon.Realtime
{
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
        ...
        private const int FriendRequestItemListMax = 512;
        ...
        public bool OpFindFriends(string[] friendsToFind, FindFriendsOptions options = null)
        {
            ...
            if (friendsToFind.Length > FriendRequestItemListMax)
            {
                this.DebugReturn(DebugLevel.ERROR, string.Format("OpFindFriends skipped: friendsToFind array exceeds allowed length of {0}.", FriendRequestItemListMax));
                return false;
            }
